<div id="group-permission-editor">
	<?php $content_types = Secdor\Section_Editing_Plugin::get_supported_post_types(); ?>
		...
		<?php foreach ( $content_types as $index => $pt ) :  ?>
			...
			<div id="perm-panel-<?php echo $pt->name; ?>" class="perm-panel <?php echo $active; ?>" data-editable-original="<?php echo htmlspecialchars( implode( ',', $editable ) ); ?>">
				...
				<div id="perm-toolbar-<?php echo $pt->name; ?>-top" class="perm-toolbar top clearfix">
					<?php if ( $hierarchical ) :  ?>
					<p class="alignright">
						<a href="#" class="perm-tree-expand" data-target="perm-editor-<?php echo $pt->name; ?>"><?php _e( 'Expand All', SECDOR_TEXTDOMAIN ); ?></a> |
						<a href="#" class="perm-tree-collapse" data-target="perm-editor-<?php echo $pt->name; ?>"><?php _e( 'Collapse All', SECDOR_TEXTDOMAIN ); ?></a>
					</p>
					<?php else : ?>
					<p class="alignleft">
						<input id="perm-search-<?php echo $pt->name; ?>" type="text" name="perm-action[][search]" class="perm-search <?php echo $hiearchical_class; ?>" >
						<button class="perm-search flat button-secondary"><?php printf( __( 'Search %s', SECDOR_TEXTDOMAIN ), $pt->label ); ?></button>
					</p>
					<p class="alignright">
				...
				<div class="perm-scroll-area">
					<input type="hidden" id="secdor-edits-<?php echo $pt->name; ?>" class="secdor-edits" name="group[perms][<?php echo $pt->name; ?>]" value="" />
